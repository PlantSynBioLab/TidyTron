...
def run(protocol: protocol_api.ProtocolContext):
    ...
    temp_module = protocol.load_module('temperature module', 9)
    watertrough = temp_module.load_labware('agilent_1_reservoir_290ml', label='Temperature-Controlled Tubes')
    ...
    r = 0
    watertrough.set_temperature(85)
