...
def run(protocol: protocol_api.ProtocolContext):
    ...
    while r < 3:
        ...
        right_pipette.mix(1,300,solutionrack['B4'].bottom(z=2))

        right_pipette.mix(2,300,solutionrack['A4'].bottom(z=2))
        
        right_pipette.mix(1,300,solutionrack['A3'].bottom(z=2))
