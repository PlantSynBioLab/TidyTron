...
def run(protocol: protocol_api.ProtocolContext):
    ...
    while r < 96:
        ...
        right_pipette.mix(3,290,solutionrack['B3'].bottom(z=1)) #bleach
        right_pipette.move_to(solutionrack['B3'].top())
        
        
        right_pipette.mix(3,295,solutionrack['A3'].bottom(z=1)) #peroxide
        right_pipette.move_to(solutionrack['A3'].top())
        
        
        right_pipette.mix(3,290,solutionrack['B2'].bottom(z=1)) #citrajet
        right_pipette.move_to(solutionrack['B2'].top())
        protocol.delay(seconds=6)

        right_pipette.mix(3,295,solutionrack['A2'].bottom(z=1)) #baking soda
        right_pipette.move_to(solutionrack['A2'].top())
        protocol.delay(seconds=6)

        right_pipette.mix(5,300,solutionrack['B1'].bottom(z=16)) #water
        right_pipette.move_to(solutionrack['B1'].top())

        right_pipette.mix(6,300,solutionrack['A1'].bottom(z=16)) #water
